<h1 style="text-align: center; font-family: helvetica">ACTA ENTREGA VEHICULO</h1>
 ...
 <div class="row">
  ...
  <div class="row">
  		 ...
  		 <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
  		 	<label>KILOMETRAJE:</label>&nbsp;&nbsp;{{$asignacion->km_entrega}}
  		 </div>
  </div>
  <hr/>
  <div class="row">
  ...
  <hr/>
  <div class="row">
  	<h3 style="text-align: center;background-color: gray">CHECK-LIST DE ENTREGA</h3>
  	<hr/>
    <table border="1" width="100%">
      ...
      <table border="0">
        ...
        <tr>
          <td><span>{{ $asignacion->encargado}}&nbsp;{{ $asignacion->apellidos}}</span> </td>
          <td colspan="5"></td>
          <td>Jefe SS.GG</td>          
        </tr>  
    </table>
